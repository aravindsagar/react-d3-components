...
import React__default, { useState, useRef, useEffect, useLayoutEffect, forwardRef, useCallback, useContext, useMemo, cloneElement, isValidElement, createRef, PureComponent } from 'react';
...
function _SimpleRectangle(props) {
    return React__default.createElement(it.rect, __assign$1({}, props));
}
var SimpleRectangle = React__default.memo(_SimpleRectangle);
...
function SequencesIcicle(_a) {
    var data = _a.data, childrenAccessor = _a.childrenAccessor, valueAccessor = _a.valueAccessor, idAccessor = _a.idAccessor, _b = _a.padding, padding = _b === void 0 ? 2 : _b, style = _a.style, className = _a.className, _c = _a.children, children = _c === void 0 ? function (p) { return React__default.createElement(SimpleRectangle, __assign$1({}, p.rect, { fill: "grey", stroke: "black" })); } : _c, rest = __rest$1(_a, ["data", "childrenAccessor", "valueAccessor", "idAccessor", "padding", "style", "className", "children"]);
    var _d = useElementSize(), width = _d.width, height = _d.height, ref = _d.ref;
    var partitioned = useMemo(function () {
    ...
    return (React__default.createElement("div", { ref: ref, style: style, className: className },
        React__default.createElement("svg", { height: height, width: width, viewBox: "0 0 ".concat(width, " ").concat(height) }, partitioned.map(function (d, idx) { return (React__default.createElement(ChildRenderer, __assign$1({ key: idAccessor ? idAccessor(d.data) : idx, item: d, idAccessor: idAccessor }, rest), children)); }))));
}
function ChildRenderer(props) {
    ...
    var isEqual = useCallback(function (a, b) {
        return idAccessor && a && b ? idAccessor(a.data) === idAccessor(b.data) : (a === null || a === void 0 ? void 0 : a.data) === (b === null || b === void 0 ? void 0 : b.data);
    }, [idAccessor]);
    var onMouseEnter = useCallback(function () { return onHover && onHover(item); }, [item, onHover]);
    var onMouseLeave = useCallback(function () { return onHover && onHover(null); }, [onHover]);
...
export { SequencesIcicle, SimpleRectangle };
